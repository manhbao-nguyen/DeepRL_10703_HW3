...
class PolicyDiffusionTransformer(nn.Module):
    ...
    def forward(self, 
        ...
        previous_observations = torch.cat((noise_timestep_embeddings.unsqueeze(1), previous_observations), dim=1)
        ...
        causal_mask = self.generate_square_subsequent_mask(input_seq_length, device=self.device)
